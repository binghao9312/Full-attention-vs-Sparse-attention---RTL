...
module chip_top #(
    ...
    localparam ADDR_RESULT_K_IDX = 6'h09;
    localparam ADDR_RESULT_SCORE_0 = 6'h0A;
    localparam ADDR_RESULT_SCORE_1 = 6'h0B;
    localparam ADDR_RESULT_SCORE_2 = 6'h0C;
    localparam ADDR_RESULT_SCORE_3 = 6'h0D;
    ...
    localparam RESULT_FIFO_WIDTH = (2 * IDX_WIDTH) + SCORE_WIDTH;
    ...
    wire [IDX_WIDTH-1:0] result_k_idx;
    wire [SCORE_WIDTH-1:0] result_score;
    ...
    assign core_score_ready = !fifo_full;
    assign fifo_push = core_score_valid && core_score_ready;
    ...
    assign result_k_idx = fifo_front[RESULT_FIFO_WIDTH-IDX_WIDTH-1 -: IDX_WIDTH];
    assign result_score = fifo_front[SCORE_WIDTH-1:0];
    ...
    assign illegal_read_addr =
        ...
        (addr != ADDR_RESULT_K_IDX) &&
        (addr != ADDR_RESULT_SCORE_0) &&
        (addr != ADDR_RESULT_SCORE_1) &&
        (addr != ADDR_RESULT_SCORE_2) &&
        (addr != ADDR_RESULT_SCORE_3) &&
    ...
    always @(*) begin
        ...
        case (addr)
            ...
            ADDR_RESULT_K_IDX: data_o = result_valid ? result_k_idx : 8'h00;
            ADDR_RESULT_SCORE_0: data_o = result_valid ? result_score[7:0] : 8'h00;
            ADDR_RESULT_SCORE_1: data_o = result_valid ? result_score[15:8] : 8'h00;
            ADDR_RESULT_SCORE_2: data_o = result_valid ? result_score[23:16] : 8'h00;
            ADDR_RESULT_SCORE_3: data_o = result_valid ? result_score[31:24] : 8'h00;
        ...
        if (!rst_n || !internal_rst_n) begin
            ...
            if (!(bus_write && (addr == ADDR_CONTROL) && data_i[4] && !busy)) begin
                if (fifo_push && fifo_pop_valid) begin
                    result_fifo[fifo_wr_ptr] <= {core_q_idx, core_k_idx, core_attention_score};
